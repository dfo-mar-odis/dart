...
class SampleTypeConfig(models.Model):
    ...
    detection_limit_field = models.CharField(verbose_name=_("Detection Limit Column"), max_length=50, blank=True,
                                             null=True, help_text=_("Lowercase name of the column that contains flags, "
                                                                    "if it exists"))
