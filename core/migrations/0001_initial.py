    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('units', models.CharField(blank=True, max_length=30, null=True, verbose_name='Units of Measure')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('sample', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, related_name='discrete_value', to='core.sample', verbose_name='Sample')),
