# Generated by Django 4.2 on 2023-12-21 14:49
...
class Migration(migrations.Migration):
    ...
    replaces = [('core', '0001_initial'), ('core', '0002_alter_sampletype_options_and_more'), ('core', '0003_sample_bio_upload_date_sample_last_modified_date'), ('core', '0004_alter_fileconfigurationmapping_options_and_more'), ('core', '0005_bcdatabaseconnections_alter_error_type_and_more'), ('core', '0006_alter_bcdatabaseconnections_engine'), ('core', '0007_rename_bcdatabaseconnections_bcdatabaseconnection'), ('core', '0008_bottle_last_modified'), ('core', '0009_missionsampletype'), ('core', '0010_remove_sample_bio_upload_date_and_more'), ('core', '0011_alter_error_type_alter_fileerror_type_and_more'), ('core', '0012_bcdatabaseconnection_uploader_and_more'), ('core', '0013_alter_mission_platform_alter_mission_protocol'), ('core', '0014_planktonsample'), ('core', '0015_planktonsample_max_sieve_planktonsample_min_sieve_and_more'), ('core', '0016_alter_planktonsample_max_sieve'), ('core', '0017_planktonsample_proc_code'), ('core', '0018_event_flow_end_event_flow_start_event_wire_out'), ('core', '0019_planktonsample_mesh_size_alter_event_flow_end'), ('core', '0020_planktonsample_plank_data_num'), ('core', '0021_alter_bottle_latitude_alter_bottle_longitude_and_more'), ('core', '0022_alter_biochemupload_modified_date')]
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('sample_type', models.ForeignKey(help_text='The sample type this config is intended for', on_delete=django.db.models.deletion.DO_NOTHING, related_name='configs', to='core.sampletype', verbose_name='Sample Type')),
            ],
        ),
        migrations.CreateModel(
            name='Sample',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('mission', models.ForeignKey(help_text='Mission a sample type was loaded for', on_delete=django.db.models.deletion.CASCADE, related_name='mission_sample_configs', to='core.mission', verbose_name='Mission')),
            ],
        ),
        migrations.CreateModel(
