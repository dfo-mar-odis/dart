...
def get_bcd_d_rows(uploader: str, samples: QuerySet[core_models.DiscreteSampleValue], batch: models.Bcbatches = None,
                   bcd_d_model: Type[models.BcdD] = models.BcdDReportModel) -> [models.BcdD]:
    ...
    for count, ds_sample in enumerate(samples):
        ...
        bcd_row = bcd_d_model(dis_detail_collector_samp_id=collector_id)
...
def get_bcd_p_rows(uploader: str, samples: QuerySet[core_models.PlanktonSample],
                   ...
                   bcd_p_model: Type[models.BcdP] = models.BcdPReportModel) -> [models.BcdP]:
    ...
    for count, sample in enumerate(samples):
        ...
        bcd_row = bcd_p_model(plank_sample_key_value=plankton_key)
